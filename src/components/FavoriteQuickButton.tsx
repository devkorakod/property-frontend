...
export function FavoriteQuickButton({ property }: { property: FavoriteProperty }) {
  ...
  return (
    <button onClick={onClick} aria-pressed={saved} title={saved ? 'ลบออกจากรายการโปรด' : 'บันทึกไว้ดูทีหลัง'}
